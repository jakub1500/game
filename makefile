all:
	...
	g++ server.cpp net/net_common.cpp world/world.cpp world/field.cpp world/player.cpp net/msg_processer.cpp net/net_session.cpp net/net_agent.cpp -pthread -o server
